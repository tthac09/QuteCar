...
#define TSENSOR_TEMPERATURE_MAX     140       /* 温度最大值 */
#define TSENSOR_TEMPERATURE_MIN     (-40)     /* 温度最小值 */
...
const at_cmd_func g_at_general_factory_test_func_tbl[] = {
    ...
    {"+FTM", 4, (at_call_back_func)at_factory_mode_query, HI_NULL, (at_call_back_func)at_factory_mode_switch, HI_NULL},
#ifndef CONFIG_FACTORY_TEST_MODE
