...
Behavior:  Reducing the number of duplicate acks for fast retransmit has drawback during minor \n
  network reordering.\n
  Our node does not realize the mitigations proposed. So MITIGATION A.1, MITIGATION A.2 and
...
#endif
#else
#undef LWIP_DEBUG_INFO
#undef LWIP_DEV_DEBUG
#endif
#ifndef LWIP_DBG_TYPES_ON
...
#define LWIP_RAND sys_arch_rand
#endif
#else
#ifndef LWIP_RAND
 ...
 * upto 255 interfaces . New versions donot have these restrictions but we stick to 10
 */
...
#define LWIP_NETIF_IFINDEX_MAX (LWIP_NETIF_NUM_MAX)
#endif
...
#ifndef LWIP_RPL_DEBUG
#define LWIP_RPL_DEBUG 1
#endif
#ifndef LWIP_IEEE802154
#define LWIP_IEEE802154 1
#endif
#endif /* LWIP_RPL */

#ifndef LWIP_RIPPLE_TIMER_COUNT
#if LWIP_RIPPLE
#define LWIP_RIPPLE_TIMER_COUNT 3
#else
#define LWIP_RIPPLE_TIMER_COUNT 0
#endif
#endif
...
#ifndef VPPRPL_CONF_RPL_TARGET_ENV
#define VPPRPL_CONF_RPL_TARGET_ENV 3
#endif

#ifndef VPPRPL_CONF_LL_80211
#define VPPRPL_CONF_LL_80211 1
#endif

#ifndef VPPRPL_CONF_RPL_CTRLMSG_WITHIPV6_HEDAER
#define VPPRPL_CONF_RPL_CTRLMSG_WITHIPV6_HEDAER 0
#endif

#ifndef RPL_CONF_MOP
#define RPL_CONF_MOP 2
#ifndef LWIP_IPV6_NUM_ROUTE_ENTRIES
#define LWIP_IPV6_NUM_ROUTE_ENTRIES 128
#endif // LWIP_IPV6_NUM_ROUTE_ENTRIES
#define VPPRPL_CONF_NUM_ROUTES_IN_SMOP LWIP_IPV6_NUM_ROUTE_ENTRIES
#endif

#if RPL_CONF_MOP == 4
#define UIP_RPL_CONF_MAX_NSMOP_NODES 128
#endif
...
#ifndef LWIP_MAC_SECURITY
#define LWIP_MAC_SECURITY 0
#endif

#ifndef LWIP_STATS_API
...
#ifndef LWIP_RPL_ROUTE_MEM_OPTIMIZE
#define LWIP_RPL_ROUTE_MEM_OPTIMIZE 1
#endif
...
#endif /* DNS_MAX_IPADDR */

#ifndef MEMP_NUM_ND6_QUEUE
#define MEMP_NUM_ND6_QUEUE          4
#endif /* MEMP_NUM_ND6_QUEUE */

#ifndef LWIP_ND6_NUM_DESTINATIONS
#define LWIP_ND6_NUM_DESTINATIONS   4
#endif /* LWIP_ND6_NUM_DESTINATIONS */

#ifndef LWIP_ND6_MAX_PREFIX_ON_INTERFACE
#define LWIP_ND6_MAX_PREFIX_ON_INTERFACE 2
#endif /* LWIP_ND6_MAX_PREFIX_ON_INTERFACE */

#ifndef LWIP_6LOWPAN
#define LWIP_6LOWPAN 0
#endif /* LWIP_6LOWPAN */

#ifndef LWIP_USE_L2_METRICS /* L2 metrics are used for mesh networks */
#define LWIP_USE_L2_METRICS 1
#endif /* LWIP_USE_L2_METRICS */

#ifndef LWIP_NBRPOLICY_ENABLE_NBR_RESTRICTION
#if LWIP_RPL
#define LWIP_NBRPOLICY_ENABLE_NBR_RESTRICTION 1
#else
