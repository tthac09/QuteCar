...
SRC_FILES = $(ap_srcs) $(mesh_srcs) $(wps_srcs) $(utils_srcs) $(other_srcs) $(eap_srcs) $(drv_srcs) $(crypto_srcs) $(common_srcs) $(sup_srcs) $(hostapd_srcs)
