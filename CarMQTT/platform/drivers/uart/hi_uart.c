 ...
 * Description: uart sdk interface implementation.
 * Author: wangjun
 * Create: 2019-04-16
 */
...
#define UART_NUMBER 2           /* uart 0,1,2 is available. */
...
hi_u32 hi_uart_quit_read(hi_uart_idx id)
{
    ...
    if (LOS_EventWrite(&udd->uart_event, UART_RD_QUIT_EVENT) != HI_ERR_SUCCESS) {
        return HI_ERR_FAILURE;
    }
