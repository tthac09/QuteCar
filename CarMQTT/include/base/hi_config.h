...
#define SOC_RAM_START 0xd8000
/* The total size of the RAM */
#define SOC_RAM_SIZE  0x46000

#define hi_is_valid_ram_addr(_x) (((hi_u32)(_x) >= (hi_u32)(uintptr_t)SOC_RAM_START) && \
    ((hi_u32)(_x) < ((hi_u32)(uintptr_t)SOC_RAM_START + (uintptr_t)SOC_RAM_SIZE)))
