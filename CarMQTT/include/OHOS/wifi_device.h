...
#ifndef HARMONY_OS_LITE_WIFI_DEVICE_H
#define HARMONY_OS_LITE_WIFI_DEVICE_H
 ...
 * For details, see {@link WfiScanParams}.
 ...
 * @version 1.0
 */
WifiErrorCode AdavanceScan(WfiScanParams *params);
