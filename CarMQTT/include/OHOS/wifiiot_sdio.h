 ...
 * @version 1.0
 */
bool SdioSendSyncMsg(unsigned int msg);
 ...
 * @version 1.0
 */
bool SdioSendMsgAck(unsigned int msg);
 ...
 * @version 1.0
 */
bool SdioProcessMsg(unsigned int sendMsg, unsigned int clearMsg);
