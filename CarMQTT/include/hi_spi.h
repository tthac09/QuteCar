...
* @param  param      [IN] type #hi_spi_cfg_basic_info，configure parameters.CNcomment:初始化SPI设备参数。CNend
*
* @retval #0               Success
* @retval #Other           Failure. For details, see hi_errno.h.
* @par 依赖:
...
*
* @attention 无。
* @param  spi_id    [IN] 类型 #hi_spi_idx，SPI ID。
* @param  lb_en     [IN] 类型 #hi_bool，loop back enable
*
* @retval #0            成功。
* @retval #Other          失败。详见hi_errno.h。
* @par 依赖:
*            @li hi_spi.h：文件用于描述SPI相关接口。
* @see  无。
* @since Hi3861_V100R001C00
*/
