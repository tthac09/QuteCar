...
*         peer_num         [IN/OUT]    Type  #unsigned int *, peer number.CNcomment:peer的个数。CNend
*
* @retval #HISI_OK        Execute successfully.
* @retval #HISI_FAIL      Execute failed.
* @par Dependency:
...
* @param  ifname           [IN]     Type  #const char *, interface name.CNcomment:接口名.CNend
* @param  ifname_len       [IN]     Type  #unsigned char, interface name length.CNcomment:接口名长度.CNend
* @param  channel          [IN]     Type  #int *, switch channel.CNcomment:信道号.CNend
* @param  switch_count     [IN]     Type  #int *, switch channel offset beacons.CNcomment:切换信道偏移beacon的个数.CNend
*
* @retval #HISI_OK  Excute successfully
* @retval #Other           Error code
* @par Dependency:
