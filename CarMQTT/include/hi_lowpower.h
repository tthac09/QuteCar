 ...
 * @attention This is an initialization API and does not support multi-task calling or repeated calling.
 CNComment:初始化操作是非多任务安全的，并且不支持重复调用。CNend
 * @param  None
 *
 * @retval #0                Success.
 ...
 *
 * @param  wakeup_src  [OUT] type #hi_udsleep_src Type of ultra deep sleep wakeup source enumeration.
 CNcomment:超深睡唤醒源CNend
 *
 * @retval #0   Success.
 * @retval #Other    Failure. For details, see hi_errno.h.
 ...
 *
 * @param  func  [IN] type #hi_void_callback_f Callback func of wake up.CNcomment:唤醒回调函数CNend
 *
 * @retval #0   Success.
 * @retval #Other    Failure. For details, see hi_errno.h.
 *
