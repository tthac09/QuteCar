...
typedef enum {
    ...
    HI_PRINT_ERRNO_CRYPTO_SALT_EMPTY_ERR = 0x3620,  /* Flash encryption and decryption root key salt is empty */
...
*
* @par 描述:
*           Serial output character buffer, specify buffer length:串口输出字符缓冲区，指定缓冲区长度。CNend
*
