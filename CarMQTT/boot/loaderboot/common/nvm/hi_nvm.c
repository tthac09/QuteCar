...
/* HI_EXTERN HI_CONST hi_u32 g_ver_magic; */
...
hi_u32 nv_read_common(hi_u8 id, hi_pvoid pdata, hi_u8 len, hi_nv_type nv_type)
{
    ...
    if (to_check_crc == HI_TRUE) {
        ...
        ret = HI_ERR_NV_LEN_ERR; /* 新项目严格要求重新来过，此处与hi3921不同 */
    }
