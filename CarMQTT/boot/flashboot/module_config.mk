boot_srcs = startup drivers/lsadc drivers/flash drivers/efuse common/crc32 common/nvm common/partition_table upg lib/lzma lzmaram secure
boot_common_srcs = ../commonboot/crc32 ../commonboot/efuse ../commonboot/flash
BOOT_CCFLAGS := -mabi=ilp32 -march=rv32imc -fldm-stm-optimize -freorder-blocks-algorithm=simple -fno-schedule-insns -nostdinc -fno-aggressive-loop-optimizations -fno-builtin -fno-exceptions -fno-short-enums -Wa,-enable-c-lbu-sb -mtune=size -msmall-data-limit=0 -Wall -Werror -Os -std=c99 -falign-functions=2 -fdata-sections -ffunction-sections -fno-common -fstack-protector-strong
BOOT_DEFINE := -DARCH_RISCV -DLOS_COMPILE_LDM -DHI_BOARD_ASIC -DCONFIG_FLASH_ENCRYPT_NOT_USE_EFUSE
...
BOOT_ASFLAGS = -mabi=ilp32 -march=rv32imc -x assembler-with-cpp -Wa,-enable-c-lbu-sb -Os -Wall -Werror -nostdinc -fno-common
BOOT_LINK_FLAGS = -nostdlib -nostartfiles -static -Wl,--gc-sections
