...
#include <../platform/drivers/adc/adc_drv.h>
#include <../components/histreaming/src/histreaming.h>
...
extern hi_void gpio5_switch_init(hi_void);
extern hi_void gpio5_interrupt_monitor(hi_void);
extern hi_u32 app_oled_i2c_demo_task(void);
extern hi_void app_demo_robot_car_task(hi_void);
...
#ifdef CONFIG_DMA_SUPPORT
    /* �����Ҫʹ��UART/SPI��DMA���ܣ�����ʹ��I2S�����ȣ���Ҫ��ʼ��DMA */
...
hi_void app_main(hi_void)
{
...
#if defined (CONFIG_FILE_SYSTEM_SUPPORT) || defined(CONFIG_FACTORY_TEST_MODE)
    ...
    hi_sal_init();
    /* �˴���ΪTRUE���ж��п��Ź���λ����ʾ��λʱPCֵ�����и�λ����ȫ���գ������汾�������ΪFALSE */
    hi_syserr_watchdog_debug(HI_FALSE);
    /* Ĭ�ϼ�¼崻���Ϣ��FLASH������Ӧ�ó������ɲ���¼������Ƶ���쳣崻�������FLASH���� */
...
#endif
#ifdef CONFIG_HISTREAMING_SUPPORT_PP
    ...
    app_demo_task_release_mem(); /* �ͷ�ϵͳջ�ڴ���ʹ������ */
    ...
    gpio5_switch_init();            //������ʼ��
    gpio5_interrupt_monitor();      //�����жϼ���task
    printf("gpio5_interrupt_monitor\n");
    app_c08i_nfc_i2c_demo_task();   //NFC��һ��task
    printf("app_c08i_nfc_i2c_demo_task\n");
    app_oled_i2c_demo_task();       //OLED��ʾ��task
    printf("app_oled_i2c_demo_task\n");
    //app_i2c_oled_demo(HI_NULL);
    app_demo_robot_car_task();      //robot car task

    app_demo_iot();
    printf("app_demo_robot_car_task\n");
}
