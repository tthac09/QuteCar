...
proj_lib_cfg = {
    ...
    'mqtt':{'mqtt':['src', os.path.join('src', 'samples')]},
    'coap':{'coap':['src']},
...
set_config('env_cfg', 'CONFIG_MQTT', 'y', ['MBEDTLS', 'HIGH_PERFORMANCE', ('LOSCFG_NET_MQTT', 'y')], 'defines', 'common')
