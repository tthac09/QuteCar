...
ifeq ($(CONFIG_HILINK), y)
	LIBS += -lhilinkdevicesdk -lhilinkota
else
ifeq ($(CONFIG_OHOS), y)
	LIBS += -lcmsis -lhichainsdk -lhos_kv_store -lhos_native_file -liothardware -lkal -lnetcfgservice -lota -lsys_parameter -lvender_hal_token -lwifiaware -lwifiservice  -lhilinkadapter_3861 -lnetcfgdevicesdk -lnetcfgota
	#LIBS += -lhctest --whole-archive -lActsParameterTest -lActsUtilsFileTest -lActsWifiawareTest -lActsWifiIotTest -lActsWifiserviceTest --no-whole-archive
endif
endif
