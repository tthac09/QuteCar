...
ifeq ($(CONFIG_OHOS), y)
	LIBS += -lcmsis -lhichainsdk -lhos_kv_store -lhos_native_file -liothardware -lkal -lnetcfgservice -lota -ltoken_static -lwifiaware -lwifiservice  -lhilinkadapter_3861 -lnetcfgdevicesdk -lnetcfgota -lposix -lauthLib
