...
if __name__=="__main__":
    ...
    if(args <= 1):
        ...
        IMAGE_TYPE_LOADER,
        IMAGE_TYPE_NORMAL,
        IMAGE_TYPE_KV_NV,        Not used currently
        IMAGE_TYPE_EFUSE,
        IMAGE_TYPE_OTP,          Not used currently
        IMAGE_TYPE_FLASHBOOT,    Not used currently
        IMAGE_TYPE_FACTORY,
        IMAGE_TYPE_VERSION,
        };
        '''
    ...
    if (argv[1] == '-packet'):
        ...
        -packet, packet all bins as one\r\n\
            param should be : -packet \"outputfile\" \"binName1|burnAddr|burnSize|type\" \"binName2|burnAddr|burnSize|type\" ...\r\n\
        example: -packet \"Hi3861_demo_allinone.bin\" \"Hi3861_loader_signed.bin|0|0|0\" \"Hi3861_demo_burn.bin|0|2052096|1\"\r\n\
        -split, split inputfile as several bins\r\n\
            param should be : -split inputfile outputPath\r\n\
        example: -split Hi3861_demo_allinone.bin .\r\n\
        -update, update bins in inputfile, if bin not in inputfile, it will be add.\r\n\
            param should be : -update \"inputefile\" \"binName1|burnAddr|burnSize|type\" ...\r\n\
        example: -update \"Hi3861_demo_allinone.bin\" \"Hi3861_demo_burn.bin|0|2052096|1\"\r\n\
        -delete, delete bins in inputfile\r\n\
            param should be : -delete inputfile binName1 binName2 ...\r\n\
        example -delete Hi3861_demo_allinone.bin Hi3861_loader_signed.bin\r\n\
        -show, show the bins in inputfile\r\n\
            param should be : -show inputfile\r\n\
        example -show Hi3861_demo_allinone.bin\r\n\
        -help\r\n")
    else:
        outputPath = argv[1]
        print(outputPath)
