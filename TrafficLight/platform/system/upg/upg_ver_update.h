...
#define UPG_UPDATE_VER_NONE     0 /* The version number is not upgraded. */
#define UPG_UPDATE_VER_FIRMARE  1 /* Upgrade the kernel version. */
#define UPG_UPDATE_VER_BOOT     2 /* Upgrade the boot version. */
