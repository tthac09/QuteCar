...
#define DEFAULT_MESH_HOLDING_TIMEOUT 1
...
struct wpa_ssid {
	...
	/* frequency and ignore_broadcast_ssid should move to here, before CONFIG_WPS macro,
	 * so that the hi_mesh.c may keep in the same binary */
	/**
