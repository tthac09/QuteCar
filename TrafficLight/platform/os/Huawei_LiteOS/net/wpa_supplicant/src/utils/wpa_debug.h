...
#else
#define wpa_debug_open_syslog() do { } while (0)
#define wpa_debug_close_syslog()  do { } while (0)
#endif /* LOS_WPA_PATCH */
...
#else
#define wpa_debug_open_linux_tracing() do { } while (0)
#define wpa_debug_close_linux_tracing()  do { } while (0)
#endif /* LOS_WPA_PATCH */
