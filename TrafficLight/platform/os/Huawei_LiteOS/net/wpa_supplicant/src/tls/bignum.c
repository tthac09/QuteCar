...
int bignum_get_unsigned_bin(const struct bignum *n, u8 *buf, size_t *len)
{
	...
	if (mp_to_unsigned_bin((mp_int *) n, buf) != MP_OKAY) {
		wpa_warning_log0(MSG_DEBUG, "BIGNUM: bignum_get_unsigned_bin failed");
		return -1;
	}
	if (len)
		*len = need;
...
int bignum_set_unsigned_bin(struct bignum *n, const u8 *buf, size_t len)
{
	if (mp_read_unsigned_bin((mp_int *) n, (u8 *) buf, len) != MP_OKAY) {
		wpa_warning_log0(MSG_DEBUG, "BIGNUM: bignum_set_unsigned_bin failed");
		return -1;
	}
	return 0;
}
	       ...
	       struct bignum *c)
{
	if (mp_add((mp_int *) a, (mp_int *) b, (mp_int *) c) != MP_OKAY) {
		wpa_warning_log0(MSG_DEBUG, "BIGNUM: bignum_add failed");
		return -1;
	}
	return 0;
}
	       ...
	       struct bignum *c)
{
	if (mp_sub((mp_int *) a, (mp_int *) b, (mp_int *) c) != MP_OKAY) {
		wpa_warning_log0(MSG_DEBUG, "BIGNUM: bignum_sub failed");
		return -1;
	}
	return 0;
}
	       ...
	       struct bignum *c)
{
	if (mp_mul((mp_int *) a, (mp_int *) b, (mp_int *) c) != MP_OKAY) {
		wpa_warning_log0(MSG_DEBUG, "BIGNUM: bignum_mul failed");
		return -1;
	}
	return 0;
}
		  ...
		  const struct bignum *c, struct bignum *d)
{
	if (mp_mulmod((mp_int *) a, (mp_int *) b, (mp_int *) c, (mp_int *) d)
	    != MP_OKAY) {
		wpa_warning_log0(MSG_DEBUG, "BIGNUM: bignum_mulmod failed");
		return -1;
	}
	return 0;
}
		   ...
		   const struct bignum *c, struct bignum *d)
{
	if (mp_exptmod((mp_int *) a, (mp_int *) b, (mp_int *) c, (mp_int *) d)
	    != MP_OKAY) {
		wpa_warning_log0(MSG_DEBUG, "BIGNUM: bignum_exptmod failed");
		return -1;
	}
	return 0;
}
