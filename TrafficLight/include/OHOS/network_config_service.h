...
/**
 * @brief Represents the minimum length (8 bytes) of a SoftAP hotspot password.
 *
 */
...
struct SoftAPParam {
     ...
     * If the password is not empty, the password length can be <b>PWD_MIN_LEN</b> to <b>PWD_MAX_LEN</b>.
     */
 ...
 *        The value must big than <b>-70</b>. To prevent a mobile phone far away from the device \n
