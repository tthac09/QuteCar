...
typedef enum {
    ...
    /** SFC chip select (CS) pin */
    WIFI_IOT_IO_NAME_SFC_CSN,
    /** SFC interface pin 1 */
    WIFI_IOT_IO_NAME_SFC_IO1,
    /** SFC interface pin 2 */
    WIFI_IOT_IO_NAME_SFC_IO2,
    /** SFC interface pin 0 */
    WIFI_IOT_IO_NAME_SFC_IO0,
    /** SFC clock pin */
    WIFI_IOT_IO_NAME_SFC_CLK,
    /** SFC interface pin 3 */
    WIFI_IOT_IO_NAME_SFC_IO3,
    /** Maximum value */
...
/**
 * @brief Enumerates the functions of the SFC_CSN pin.
 */
typedef enum {
    /** SFC CSN function (default value) */
    WIFI_IOT_IO_FUNC_SFC_CSN_SFC_CSN,
    /** SDIO D2 function */
    WIFI_IOT_IO_FUNC_SFC_CSN_SDIO_D2,
    /** GPIO9 function */
    WIFI_IOT_IO_FUNC_SFC_CSN_GPIO9,
    /** SPI1 TXD function */
    WIFI_IOT_IO_FUNC_SFC_CSN_SPI1_TXD = 4,
} WifiIotIOFuncSfcCsn;

/**
 * @brief Enumerates the functions of the SFC_DI pin.
 */
typedef enum {
    /** SFC DI function (default value) */
    WIFI_IOT_IO_FUNC_SFC_IO_0_SFC_DI,
    /** SDIO CLK function */
    WIFI_IOT_IO_FUNC_SFC_IO_0_SDIO_CLK,
    /** GPIO12 function */
    WIFI_IOT_IO_FUNC_SFC_IO_0_GPIO12,
    /** RF RX_EN_EXT function */
    WIFI_IOT_IO_FUNC_SFC_IO_0_RF_RX_EN_EXT,
    /** SPI0 CSN function */
    WIFI_IOT_IO_FUNC_SFC_IO_1_SPI0_CSN,
} WifiIotIoFuncSfcIo0;

/**
 * @brief Enumerates the functions of the SFC_DO pin.
 */
typedef enum {
    /** SFC D0 function (default value) */
    WIFI_IOT_IO_FUNC_SFC_IO_1_SFC_DO,
    /** SDIO D3 function */
    WIFI_IOT_IO_FUNC_SFC_IO_1_SDIO_D3,
    /** GPIO10 function */
    WIFI_IOT_IO_FUNC_SFC_IO_1_GPIO10,
    /** SPI0 CK function */
    WIFI_IOT_IO_FUNC_SFC_IO_1_SPI0_CK = 4,
} WifiIotIoFuncSfcIo1;

/**
 * @brief Enumerates the functions of the SFC_WPN pin.
 */
typedef enum {
    /** SFC WPN function (default value) */
    WIFI_IOT_IO_FUNC_SFC_IO_2_SFC_WPN,
    /** SDIO CMD function */
    WIFI_IOT_IO_FUNC_SFC_IO_2_SDIO_CMD,
    /** GPIO11 function */
    WIFI_IOT_IO_FUNC_SFC_IO_2_GPIO11,
    /** RF TX_EN_EXT function */
    WIFI_IOT_IO_FUNC_SFC_IO_2_RF_TX_EN_EXT,
    /** SPI0 RXD function */
    WIFI_IOT_IO_FUNC_SFC_IO_1_SPI0_RXD,
} WifiIotIoFuncSfcIo2;

/**
 * @brief Enumerates the functions of the SFC_HOLDN pin.
 */
typedef enum {
    /** SFC HOLDN function (default value) */
    WIFI_IOT_IO_FUNC_SFC_IO_3_SFC_HOLDN,
    /** SDIO D1 function */
    WIFI_IOT_IO_FUNC_SFC_IO_3_SDIO_D1,
    /** GPIO14 function */
    WIFI_IOT_IO_FUNC_SFC_IO_3_GPIO14,
    /** SSI CLK function */
    WIFI_IOT_IO_FUNC_SFC_IO_3_SSI_CLK = 4,
} WifiIotIoFuncSfcIo3;

/**
 * @brief Enumerates the functions of the SFC_CLK pin.
 */
typedef enum {
    /** SFC CLK function (default value) */
    WIFI_IOT_IO_FUNC_SFC_CLK_SFC_CLK,
    /** SDIO D0 function */
    WIFI_IOT_IO_FUNC_SFC_CLK_SDIO_D0,
    /** GPIO13 function */
    WIFI_IOT_IO_FUNC_SFC_CLK_GPIO13,
    /** SSI DATA function */
    WIFI_IOT_IO_FUNC_SFC_CLK_SSI_DATA = 4,
} WifiIotIoFuncSfcClk;
