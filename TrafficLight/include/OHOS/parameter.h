 ...
 * @return Returns the number of bytes of the system parameter if a result is found; returns <b>-1</b> otherwise.
 * @since 1.0
 * @version 1.0
 */
 ...
 * @return Returns <b>0</b> if the system parameter is set or updated; returns <b>-1</b> otherwise.
 * @since 1.0
 * @version 1.0
 */
